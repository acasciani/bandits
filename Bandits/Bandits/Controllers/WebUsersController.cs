...
{
    /// <summary>
    /// Web API Controller for WebUsers entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class WebUsersController : OpenAccessBaseApiController<BanditsModel.WebUser, BanditsModel.BanditsModel>
    {
        ...
        public WebUsersController(IOpenAccessBaseRepository<BanditsModel.WebUser , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.WebUser Get(Int32 id)
        {
            BanditsModel.WebUser entity = repository.GetBy(b => b.WebUserId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.WebUser entity)
        {
                        if (entity == null ||
                id != entity.WebUserId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.WebUser entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.WebUser>(httpStatusCode, entityToEmbed);
