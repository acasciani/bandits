...
{
    /// <summary>
    /// Web API Controller for Guardians entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class GuardiansController : OpenAccessBaseApiController<BanditsModel.Guardian, BanditsModel.BanditsModel>
    {
        /// <summary>
        ...
        public GuardiansController(IOpenAccessBaseRepository<BanditsModel.Guardian , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Guardian Get(Int32 id)
        {
            BanditsModel.Guardian entity = repository.GetBy(b => b.GuardianId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Guardian entity)
        {
                        if (entity == null ||
                id != entity.GuardianId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Guardian entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Guardian>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.GuardianId });
