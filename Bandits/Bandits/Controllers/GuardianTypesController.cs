...
{
    /// <summary>
    /// Web API Controller for GuardianTypes entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class GuardianTypesController : OpenAccessBaseApiController<BanditsModel.GuardianType, BanditsModel.BanditsModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public GuardianTypesController()
        {
            this.repository = new GuardianTypeRepository();
        }
        ...
        public GuardianTypesController(IOpenAccessBaseRepository<BanditsModel.GuardianType , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.GuardianType Get(Int32 id)
        {
            BanditsModel.GuardianType entity = repository.GetBy(b => b.GuardianTypeId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.GuardianType entity)
        {
                        if (entity == null ||
                id != entity.GuardianTypeId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.GuardianType entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.GuardianType>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.GuardianTypeId });
