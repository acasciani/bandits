...
{
    /// <summary>
    /// Web API Controller for People entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class PeopleController : OpenAccessBaseApiController<BanditsModel.Person, BanditsModel.BanditsModel>
    {
        ...
        public PeopleController(IOpenAccessBaseRepository<BanditsModel.Person , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Person Get(Int32 id)
        {
            BanditsModel.Person entity = repository.GetBy(b => b.PersonId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Person entity)
        {
                        if (entity == null ||
                id != entity.PersonId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Person entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Person>(httpStatusCode, entityToEmbed);
