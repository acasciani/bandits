...
{
    /// <summary>
    /// Web API Controller for Auth_ScopeAssignments entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class Auth_ScopeAssignmentsController : OpenAccessBaseApiController<BanditsModel.Auth_ScopeAssignment, BanditsModel.BanditsModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public Auth_ScopeAssignmentsController()
        {
            this.repository = new Auth_ScopeAssignmentRepository();
        }
        ...
        public Auth_ScopeAssignmentsController(IOpenAccessBaseRepository<BanditsModel.Auth_ScopeAssignment , BanditsModel.BanditsModel> repository)
        {
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Auth_ScopeAssignment entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Auth_ScopeAssignment>(httpStatusCode, entityToEmbed);
