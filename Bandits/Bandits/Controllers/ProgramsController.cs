...
{
    /// <summary>
    /// Web API Controller for Programs entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class ProgramsController : OpenAccessBaseApiController<BanditsModel.Program, BanditsModel.BanditsModel>
    {
        ...
        public ProgramsController(IOpenAccessBaseRepository<BanditsModel.Program , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Program Get(Int32 id)
        {
            BanditsModel.Program entity = repository.GetBy(b => b.ProgramId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Program entity)
        {
                        if (entity == null ||
                id != entity.ProgramId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Program entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Program>(httpStatusCode, entityToEmbed);
