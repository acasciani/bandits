...
{
    /// <summary>
    /// Web API Controller for Auth_Roles entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class Auth_RolesController : OpenAccessBaseApiController<BanditsModel.Auth_Role, BanditsModel.BanditsModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public Auth_RolesController()
        {
            this.repository = new Auth_RoleRepository();
        }
        ...
        public Auth_RolesController(IOpenAccessBaseRepository<BanditsModel.Auth_Role , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Auth_Role Get(Int32 id)
        {
            BanditsModel.Auth_Role entity = repository.GetBy(b => b.RoleId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Auth_Role entity)
        {
                        if (entity == null ||
                id != entity.RoleId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Auth_Role entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Auth_Role>(httpStatusCode, entityToEmbed);
