...
{
    /// <summary>
    /// Web API Controller for Teams entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class TeamsController : OpenAccessBaseApiController<BanditsModel.Team, BanditsModel.BanditsModel>
    {
        /// <summary>
        ...
        public TeamsController(IOpenAccessBaseRepository<BanditsModel.Team , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Team Get(Int32 id)
        {
            BanditsModel.Team entity = repository.GetBy(b => b.TeamId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Team entity)
        {
                        if (entity == null ||
                id != entity.TeamId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Team entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Team>(httpStatusCode, entityToEmbed);
