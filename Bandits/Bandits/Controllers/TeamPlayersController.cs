...
{
    /// <summary>
    /// Web API Controller for TeamPlayers entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class TeamPlayersController : OpenAccessBaseApiController<BanditsModel.TeamPlayer, BanditsModel.BanditsModel>
    {
        /// <summary>
        ...
        public TeamPlayersController(IOpenAccessBaseRepository<BanditsModel.TeamPlayer , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.TeamPlayer Get(Int32 id)
        {
            BanditsModel.TeamPlayer entity = repository.GetBy(b => b.TeamPlayerId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.TeamPlayer entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.TeamPlayer entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.TeamPlayer>(httpStatusCode, entityToEmbed);
