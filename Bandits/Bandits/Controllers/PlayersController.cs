...
{
    /// <summary>
    /// Web API Controller for Players entity defined in BanditsModel.BanditsModel data model
    /// </summary>
    public partial class PlayersController : OpenAccessBaseApiController<BanditsModel.Player, BanditsModel.BanditsModel>
    {
        ...
        public PlayersController(IOpenAccessBaseRepository<BanditsModel.Player , BanditsModel.BanditsModel> repository)
        {
        ...
        public virtual BanditsModel.Player Get(Int32 id)
        {
            BanditsModel.Player entity = repository.GetBy(b => b.PlayerId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, BanditsModel.Player entity)
        {
                        if (entity == null ||
                id != entity.PlayerId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, BanditsModel.Player entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<BanditsModel.Player>(httpStatusCode, entityToEmbed);
